...
plot(brick(initial[1]), main = "BOA image"); plot(readOGR(final[1]), main = "segments")
plot(brick(initial[1])[[1]]); plot(readOGR(final[1]), add=T)
```
...
r = dropLayer(r, "LS2")
r = approxNA(r)
names(r) = c("C","B","G","Y","R","RE","N1","N","LS3","LS4","EE","HA1","HA2","HA3","HA4","HA5","HA6","HA7","HA8")
...
# pc = spTransform(pc, "+init=epsg:32618")

# plot(r[[1]]);plot(pc,add=T)
...
# rownames(zonal_s)=as.numeric(rownames(zonal_s))+1

pc2=pc

# pc2@data = merge(pc@data,zonal_s, by.x="DN",by.y="row.names")
...
sfInit(parallel=TRUE, cpus=parallel::detectCores()-1)
sfExport("tifs","shps","output_shps","classify_tiles","rf","minx","maxx","meanx","sdx","zonal.stats.small")
sfLibrary(rgdal)
sfLibrary(raster)
...
plot(m)
st_write(m,
         "D:/Arthur/digitalglobe_archives/water_mask/landmask_2019_10_P002.gpkg",
         driver="GPKG",
         delete_dsn=T)
glint_imgs
```
...
test = raster::extract(r, pc, method='simple',fun='mean', na.rm=T)
?zonal
...
v = brick("D:/Arthur/digitalglobe_archives/water_mask/tiles/tif/T_1.tif")
v[is.na(v)] <- 1000 
plot(v[[11]]) # a lot of actual NAs
test = v[[8]]
...
v = brick("D:/Arthur/digitalglobe_archives/destripe/all/2019-08-02_MUL_WV03_2019-08-02_010577871010_01_P001.tif")
...
v = brick("D:/Arthur/digitalglobe_archives/boa/MUL/2019-08-02_MUL_WV03_2019-08-02_010577871010_01_P001.tif")
plot(v[[8]])
test = v[[8]]
test[is.na(test)] = 1000
t2 = crop(test,r)
