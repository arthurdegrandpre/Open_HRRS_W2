...
New : loop and correct to mean 


```{r}
# define paths 
raster_dir = dir("D:/Arthur/digitalglobe_archives/doscost", pattern=".tif$",full.names=T)
...
loop as function (correct to left)
...
writeRaster(r2, paste0("D:/Arthur/digitalglobe_archives/destripe/",gsub(".*doscost/","",imgs[i])), overwrite=T)
}
# dir("D:/Arthur/digitalglobe_archives/water_mask/",pattern=".tif$")
# plot(r[[5]])
# plot(r2[[5]])
