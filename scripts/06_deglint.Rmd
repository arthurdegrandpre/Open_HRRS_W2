...
This script comes after land masking and will perform empirical deglinting of water pixels. In order to perform correctly, all non glint NIR sources should be masked out during the previous step. If it is not the case, non glint NIR signal will be wrongly corrected.  
...
```{r}
input_imgs = "C:/Users/Arthur/Documents/data/hrrs_work/land_classification_output/"
input_deep = "../data/deep_zones/"
tdi_table = read.csv("../data/radiometric_calibration_parameters.csv")
  
output_dir = "C:/Users/Arthur/Documents/data/hrrs_work/land_classification_output/deglint/"
```
