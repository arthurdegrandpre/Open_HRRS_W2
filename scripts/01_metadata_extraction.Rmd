...
```{r finding images}
imgs_dir = "//Glaciolab/home/MFFP" # directory containing all satellite images (can be in different folders, to be found with recursive search)
...
tdi = as.factor(
  gsub(";","", droplevels(
    subset(imdx, imdx$V1 %like% "TDILevel")$V2
  )))
