...
hist(na.omit(getValues(r2[[b]])))

  print("ARC")
# TOA ######################
# calcEarthSunDist(rctx$date[b])
#   
  r32 = (r2*(1.001^2)*pi) / # this gives TOA
...
writeRaster(r3,paste0(mul_toa_output, as.Date(rctx$date[1]),"test_MUL_",rctx$sats[1],"_",str_sub(img,-29)[1],".tif"), overwrite=T)
}
```
