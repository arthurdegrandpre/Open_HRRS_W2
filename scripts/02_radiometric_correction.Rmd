...
r = brick(paste0(img$path)) # load image into R raster
...
print(paste0(i,"/",length(mul$X))) # to track progress
...
#### NOTE : the following line can be used to write the absolute radiometric calibration product, if needed
 # writeRaster(r2,paste0(pan_arc_output, as.Date(rctx$date[1]),"_MUL_",rctx$sats[1],"_",str_sub(img,-29)[1]), overwrite=T)
