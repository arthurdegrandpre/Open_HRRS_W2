...
#input
boa_input = dir("C:/Users/Arthur/Documents/rscripts/Open_HRRS_W2/data/work/destripe_output/",full.names=T,pattern=".tif$") # Relative paths NOT ACCEPTED because of cmd call
MUL_input = boa_input[str_detect(boa_input, "MUL")]

#output
segmentation_output = paste0("C:/Users/Arthur/Documents/rscripts/Open_HRRS_W2/data/work/segmentation_output/") # Relative paths NOT ACCEPTED because of cmd call
...
for(i in seq_along(MUL_input)){
  ...
  meanshift.segm(filter.meanshift.spatialr = "5",      # default 5
               filter.meanshift.ranger   = "0.0015",  # default 15 # low for 2019
               filter.meanshift.thres    = "0.001",  # default 0.1
               filter.meanshift.maxiter  = "100",    # default 100
               filter.meanshift.minsize  = "5",     # default 100
