...
Author: Arthur de Grandpre
Supervised by: Pr Andrea Bertolo (UQTR), Pr Christophe Kinnard (UQTR)
Collaboration of: 

Dependant on (libraries and applications)
Financed by (ÉcoLac & CEGRIM)
